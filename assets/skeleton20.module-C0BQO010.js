const a=`.loader {
  ...
  background-size:
    ...
    calc(280 * var(--size)) calc(20 * var(--size)),
    calc(60 * var(--size)) calc(120 * var(--size)),
    calc(60 * var(--size)) calc(80 * var(--size)),
    calc(60 * var(--size)) calc(140 * var(--size)),
    calc(60 * var(--size)) calc(100 * var(--size));
  background-position:
    -50% 0,
    0 0,
    0 100%,
    calc(80 * var(--size)) 100%,
    calc(160 * var(--size)) 100%,
    calc(240 * var(--size)) 100%;
