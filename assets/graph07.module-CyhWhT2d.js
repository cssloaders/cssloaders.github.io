const a=`.loader {
  ...
  border-width: calc(40 * var(--size)) calc(60 * var(--size)) calc(30 * var(--size))
    calc(60 * var(--size));
  border-color: var(--color-1) var(--color-2) var(--color-2) var(--color-3);
...
@keyframes envFloating {
  0% {
    transform: translate(calc(-2 * var(--size)), calc(-5 * var(--size)));
  }
  100% {
