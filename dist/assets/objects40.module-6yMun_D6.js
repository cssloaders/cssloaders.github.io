...
@keyframes animloader {
  0% {
    background-position: 0 calc(80 * var(--size));
  }
  100% {
    background-position: 0 0;
  }
...
@keyframes animloader1 {
  ...
  80% {
    box-shadow:
      calc(2 * var(--size)) calc(-80 * var(--size)) var(--color-4),
      calc(4 * var(--size)) calc(-70 * var(--size)) var(--color-5),
      calc(8 * var(--size)) calc(-120 * var(--size)) var(--color-3),
      calc(12 * var(--size)) calc(-35 * var(--size)) var(--color-4);
  }
  100% {
    box-shadow:
